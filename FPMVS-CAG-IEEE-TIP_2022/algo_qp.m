function [UU,A,W,Z,iter,obj,alpha,U] = algo_qp(X,Y,lambda,d,numanchor)
...
options = optimset( 'Algorithm','interior-point-convex','Display','off'); % Algorithm é»č®¤ä¸? interior-point-convex
